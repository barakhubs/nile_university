                    ...
                    <div class="card-body p-2">
                                ...
                                <tr>
                                    <td class="col-md-6">
                                        ...
                                        <p class="fs-sm">
                                            Email:
                                            <br>
                                            <a href="mailto('{{ $student->email }}')" class="text-purple">{{ $student->email }}
                                            </a>
                                        </p>
                                    </td>
                                    <td class="col-md-6 text-md-end">
                                        ...
                                        <p class="fs-sm">
                                            ...
                                            <br>
                                            <span class="text-purple">{{ $student->program->title }}
                                            </span>
                                        </p>
                                    </td>
                                </tr>
                            ...
                            <thead>
                                <tr>
                                    <th colspan="5" scope="col"
                                        ...
                                        {{ config('nile_university.year') }}</th>
                                    <th colspan="4" scope="col"
                                        class="fs-sm text-dark text-uppercase-bold-sm text-end px-0">
                                        {{ config('nile_university.semester') }}</th>
                                </tr>
                            </thead>
                        </table>
                        ...
                        <table class="mt-5">
                            <tr>
                                ...
                                <td class="col-md-6">
                                    <div class="text-muted mb-2">{{ $total_credit_units_score / $total_credit_units }}
                                    </div>
                                </td>
                            </tr>
                            {{-- <tr>
